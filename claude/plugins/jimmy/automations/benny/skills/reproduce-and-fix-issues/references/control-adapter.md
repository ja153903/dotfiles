...
Set the completed user-facing feature map path in `control.feature_map_path`. Copy and fill [`feature-map.example.md`](./feature-map.example.md) to a user-owned path the pack does not manage instead of editing the copied example.
